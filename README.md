...
[![Version](https://img.shields.io/badge/version-0.13.2-blue)](#-installation)
...
| 14  | Site maps / regional choropleths (lon/lat, built-in NE 50m basemap) | PlotlyGeo           | `templates/plotly-geo.html` |
| 15  | Local maps with real coastline detail (GeoJSON: NE 10m / OSM / GIS exports) | GeoMap         | `templates/geomap.html`    |
...
| [d3-geo](https://github.com/d3/d3-geo)      | 3.1.1          | GeoMap projections (+ vendored NE topology in PlotlyGeo) | ISC  |
